...
handles.Edit_CameraExpTimeSeqActual = uicontrol('Parent',hCameraPanel, 'Style', 'edit', 'String',num2str(obj.TIRF.CameraObj.SequenceCycleTime),'Enable','off','Position', [250 php-130 50 20]);
...
powerString405 = sprintf('[%g, %g] (%s)',obj.TIRF.Laser405.MinPower,obj.TIRF.Laser405.MaxPower, obj.TIRF.Laser405.PowerUnit);
...
handles.HP488 = uicontrol(h488Panel,'Style','edit',...
                'Position',[15 25 30 20]);
powerString488 = sprintf('[%g, %g] (%s)',obj.TIRF.Laser488.MinPower,obj.TIRF.Laser488.MaxPower, obj.TIRF.Laser488.PowerUnit);
...
handles.HP561 = uicontrol(h561Panel,'Style','edit',...
                'Position',[15 25 30 20]);
powerString561 = sprintf('[%g, %g] (%s)',obj.TIRF.Laser561.MinPower,obj.TIRF.Laser561.MaxPower, obj.TIRF.Laser561.PowerUnit);
...
handles.HP642 = uicontrol(h642Panel,'Style','edit',...
                'Position',[15 25 30 20]);
powerString642 = sprintf('[%g, %g] (%s)',obj.TIRF.Laser642.MinPower,obj.TIRF.Laser642.MaxPower, obj.TIRF.Laser642.PowerUnit);
...
powerStringLamp = sprintf('[%g, %g] (%s)',obj.TIRF.LampObj.MinPower,obj.TIRF.LampObj.MaxPower, obj.TIRF.LampObj.PowerUnit);
...
%            pause(obj.TIRF.LampWait);
    ...
    function setLaser405Low(~,~)
        obj.TIRF.Laser405.setPower(str2double(handles.LP405.String));
    end

    function setLaser488Low(~,~)
        obj.TIRF.Laser405.setPower(str2double(handles.LP488.String));
    end

    function setLaser561Low(~,~)
        obj.TIRF.Laser405.setPower(str2double(handles.LP561.String));
    end

    function setLaser642Low(~,~)
        obj.TIRF.Laser405.setPower(str2double(handles.LP642.String));
    end
    ...
    function zoom_set(~,~)
        ...
        switch zoom_val
            case 1
                obj.TIRF.CameraObj.DisplayZoom = 0.5;
            case 2
                obj.TIRF.CameraObj.DisplayZoom = 1;
            case 3
                obj.TIRF.CameraObj.DisplayZoom = 2;
            case 4
                obj.TIRF.CameraObj.DisplayZoom = 4;
            case 5
                obj.TIRF.CameraObj.DisplayZoom = 10;
        end
    ...
    function gain_set(~,~)
        ...
        switch gain_val
            case 1
                obj.TIRF.CameraEMGainHigh=100;
            case 2
                obj.TIRF.CameraEMGainHigh=200;
        end
    end
    ...
    function sequence_set(~,~)
        ...
        obj.TIRF.CameraObj.AcquisitionType = 'sequence';
        obj.TIRF.CameraObj.setup_acquisition;
        set(handles.Edit_CameraExpTimeSeqActual,'String',num2str(obj.TIRF.CameraObj.SequenceCycleTime));
    end
...
%         obj.TIRF.CameraGain=get(handles.Popup_CameraGain,'value');
...
%         set(handles.Popup_CameraGain,'value',obj.TIRF.CameraGain);
